...
#import "@rheo/rookery:0.1.2": footnote, idea, ideas-outline, note, todo, window
...
#idea("hatching-ideas", title: [Hatching ideas])[
  ...
  ```typ
  #import "@rheo/rookery:0.1.2": todo, note
...
#idea("referencing-ideas", title: [Referencing ideas])[
  ...
  #idea("hyperlinks", title: [Hyperlinks])[
    ...
    ```typ
    #import "@rheo/rookery:0.1.2": hyperlink
    - @idea:first-idea
  ...
  #idea("windows", title: [Windows])[
    ...
    ```typ
    #import "@rheo/rookery:0.1.2": window
    #window(<first-idea>)
    ```
