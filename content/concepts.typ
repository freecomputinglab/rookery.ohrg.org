...
#import "@rheo/rookery:0.2.0": footnote, idea, ideas-outline, note, todo, window
...
#idea("hatching-ideas", title: [Hatching ideas])[
  ...
  ```typ
  #import "@rheo/rookery:0.2.0": todo, note
...
#idea("referencing-ideas", title: [Referencing ideas])[
  ...
  #idea("hyperlinks", title: [Hyperlinks])[
    ...
    ```typ
    #import "@rheo/rookery:0.2.0": hyperlink
    - @idea:first-idea
  ...
  #idea("windows", title: [Windows])[
    ...
    ```typ
    #import "@rheo/rookery:0.2.0": window
    #window(<first-idea>)
    ```
